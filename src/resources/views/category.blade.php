...
<body>
   ...
   @include('komponenty.sekcje.navbar')
    ...
    <main id="home-page">
        ...
        <section class="container-col gen-padding width-100 paralax" style="background-image: url('{{ asset('images/'.$category->name . '-bg.png') }}'); height: 50vh;">
                    ...
                    @foreach($category->subcategories as $subcategory)
                        ...
                        <a href="{{ route('product.show', [
                            ...
                            <div class="container-row product-card width-100 gap-32">
                                <div class="container-col product-card-image al-self-start">
